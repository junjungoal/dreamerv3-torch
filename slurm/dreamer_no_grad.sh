...
WANDB__SERVICE_WAIT=300 python3 dreamer.py --configs dmc_proprio_reinforce_no_grad --task dmc_$TASK --logdir ./logdir/$TASK/$GROUP/$SEED --seed $SEED --group $GROUP-$TASK
