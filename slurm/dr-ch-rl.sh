...
WANDB__SERVICE_WAIT=300 python3 dreamer.py --steps 1.5e6 --configs gym_proprio --task gym_$TASK --logdir /jmain02/home/J2AD008/wga37/mxr40-wga37/logdir/dreamerv3/$TASK/$GROUP/$SEED --seed $SEED --group $GROUP
